...
class LodgingCard extends StatefulWidget {
  LodgingCard(
    this.ageGroup,
    this.lodgingRoomAmount,
    this.lodgingRoomCheckoutSum,
  );

  final String ageGroup;
  int lodgingRoomAmount;
  int lodgingRoomCheckoutSum;

  @override
  _LodgingCardState createState() => _LodgingCardState();
}

class _LodgingCardState extends State<LodgingCard> {
  ...
  Widget build(BuildContext context) {
    int price = widget.lodgingRoomCheckoutSum * widget.lodgingRoomAmount;
    return Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Text(
                        '\$${widget.lodgingRoomCheckoutSum * widget.lodgingRoomAmount}',
                        style: TextStyle(
                          fontSize: 25,
                          color: Colors.green,
                        ),
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            if (widget.lodgingRoomAmount >= 1) {
                              widget.lodgingRoomAmount--;
                            }
                          });
                        },
                      ),
                    ...
                    Flexible(
                      flex: 2,
                      child: Text(
                        widget.lodgingRoomAmount.toString(),
                        style: TextStyle(
                          fontSize: 30,
                          color: Colors.green,
                        ),
