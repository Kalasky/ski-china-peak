...
class SummerCard extends StatefulWidget {
  SummerCard(
    this.ageGroup,
    this.summerServiceAmount,
    this.summerServiceCheckoutSum,
  );

  final String ageGroup;
  int summerServiceAmount;
  int summerServiceCheckoutSum;

  @override
  _SummerCardState createState() => _SummerCardState();
}

class _SummerCardState extends State<SummerCard> {
  ...
  Widget build(BuildContext context) {
    int price = widget.summerServiceCheckoutSum * widget.summerServiceAmount;
    return Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Text(
                        '\$${widget.summerServiceCheckoutSum * widget.summerServiceAmount}',
                        style: TextStyle(
                          fontSize: 22,
                          color: Colors.green,
                        ),
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            if (widget.summerServiceAmount >= 1) {
                              widget.summerServiceAmount--;
                            }
                          });
                        },
                      ),
                    ...
                    Flexible(
                      flex: 2,
                      child: Text(
                        widget.summerServiceAmount.toString(),
                        style: TextStyle(
                          fontSize: 30,
                          color: Colors.green,
                        ),
