...
class LessonsCard extends StatefulWidget {
  LessonsCard(
    this.ageGroup,
    this.lessonTicketAmount,
    this.lessonTicketCheckoutSum,
  );

  final String ageGroup;
  int lessonTicketAmount;
  int lessonTicketCheckoutSum;
...
class _LessonsCardState extends State<LessonsCard> {
  ...
  Widget build(BuildContext context) {
    int price = widget.lessonTicketCheckoutSum * widget.lessonTicketAmount;
    return Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Text(
                        '\$${widget.lessonTicketCheckoutSum * widget.lessonTicketAmount}',
                        style: TextStyle(
                          fontSize: 30,
                          color: Colors.green,
                        ),
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            if (widget.lessonTicketAmount >= 1) {
                              widget.lessonTicketAmount--;
                            }
                          });
                        },
                      ),
                    ...
                    Flexible(
                      flex: 2,
                      child: Text(
                        widget.lessonTicketAmount.toString(),
                        style: TextStyle(
                          fontSize: 30,
                          color: Colors.green,
                        ),
