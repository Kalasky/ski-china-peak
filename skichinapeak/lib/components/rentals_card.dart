...
class RentalsCard extends StatefulWidget {
  RentalsCard(
    this.ageGroup,
    this.rentalItemAmount,
    this.rentalItemCheckoutSum,
//    this.content,
//    this.price,
//    this.buttonText,
//    this.checkoutPrice,
...
//  final String ageGroup, content, price, buttonText, checkoutPrice, ageCheckout;
  ...
  int rentalItemAmount;
  int rentalItemCheckoutSum;

  @override
  _RentalsCardState createState() => _RentalsCardState();
}

class _RentalsCardState extends State<RentalsCard> {
  ...
  Widget build(BuildContext context) {
    int price = widget.rentalItemCheckoutSum * widget.rentalItemAmount;
    return Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Text(
                        '\$${widget.rentalItemCheckoutSum * widget.rentalItemAmount}',
                        style: TextStyle(
                          fontSize: 30,
                          color: Colors.green,
                        ),
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            if (widget.rentalItemAmount >= 1) {
                              widget.rentalItemAmount--;
                            }
                          });
                        },
                      ),
                    ...
                    Flexible(
                      flex: 2,
                      child: Text(
                        widget.rentalItemAmount.toString(),
                        style: TextStyle(
                          fontSize: 25,
                          color: Colors.green,
                        ),
